...
vtkStandardNewMacro(myResliceInteractionStyle);
 

void myResliceInteractionStyle::SetOperacao(int idBotao, int operacao)
{
...
//----------------------------------------------------------------------------
void myResliceInteractionStyle::OnMouseMove()
{
...
//----------------------------------------------------------------------------
void myResliceInteractionStyle::OnLeftButtonDown()
{
...
//----------------------------------------------------------------------------
void myResliceInteractionStyle::OnLeftButtonUp()
{
	this->State = OperacoesDoMouse[currentMouseButton];
	switch (this->State)
	{
...
//----------------------------------------------------------------------------
void myResliceInteractionStyle::OnMiddleButtonDown()
{
...
//----------------------------------------------------------------------------
void myResliceInteractionStyle::OnMiddleButtonUp()
{
	this->State = OperacoesDoMouse[currentMouseButton];
	switch (this->State)
	{
...
//----------------------------------------------------------------------------
void myResliceInteractionStyle::OnRightButtonDown()
{
...
//----------------------------------------------------------------------------
void myResliceInteractionStyle::OnRightButtonUp()
{
	this->State = OperacoesDoMouse[currentMouseButton];
	switch (this->State)
	{
...
//----------------------------------------------------------------------------
void myResliceInteractionStyle::Rotate()
{
	if (this->CurrentRenderer == nullptr || this->InteractionProp == nullptr)
	{
		return;
...
//----------------------------------------------------------------------------
void myResliceInteractionStyle::Pan()
{
	if (this->CurrentRenderer == nullptr || this->InteractionProp == nullptr)
	{
		return;
...
//----------------------------------------------------------------------------
void myResliceInteractionStyle::Dolly()
{
	if (this->CurrentRenderer == nullptr || this->InteractionProp == nullptr)
	{
		return;
...
//----------------------------------------------------------------------------
void myResliceInteractionStyle::UniformScale()
{
	if (this->CurrentRenderer == nullptr || this->InteractionProp == nullptr)
	{
		return;
...
//----------------------------------------------------------------------------
void myResliceInteractionStyle::PrintSelf(ostream& os, vtkIndent indent)
{
	this->Superclass::PrintSelf(os, indent);
}

//----------------------------------------------------------------------------
void myResliceInteractionStyle::FindPickedActor(int x, int y)
{
...
//----------------------------------------------------------------------------
void myResliceInteractionStyle::Prop3DTransform(vtkProp3D *prop3D,
	double *boxCenter,
	int numRotation,
	double **rotate,
	double *scale)
